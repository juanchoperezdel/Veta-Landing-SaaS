...
import { Check, Code2, GitBranch, Layers } from 'lucide-react';
import { motion } from 'framer-motion';
import { AvatarCircles } from '../ui/avatar-circles';

const HeroFactory: React.FC = () => {
  return (
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 relative z-10">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm font-medium text-white/80">Elegido por +20 empresas</span>
              </div>
            </motion.div>
            ...
            >
              Software a medida que se entrega. <br />
              <span className="text-gradient">Sin retrasos, sin excusas.</span>
            </motion.h1>
            ...
            >
              Construimos aplicaciones web, mobile, integraciones y automatizaciones con IA para empresas que necesitan crecer con tecnología propia.
            </motion.p>
            ...
            >
              <span className="block mb-1 text-white/90">Primeras pantallas funcionales en 2–3 semanas.</span>
              <span className="opacity-80 block">Código tuyo, documentado y listo para escalar.</span>
            </motion.p>
          </div>
          ...
          >
            <div className="relative glass-panel rounded-3xl p-8 purple-glow transform transition-transform duration-500 hover:rotate-0">
              ...
              <div className="mb-8">
                <div className="text-[10px] font-bold text-fino-purple uppercase mb-2 tracking-wider">VETA DEV · SOFTWARE FACTORY + IA</div>
                <div className="text-2xl font-semibold text-white">Discovery · Build · Deploy · Automate</div>
              </div>
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-white/5 rounded-2xl p-5 border border-white/5 hover:bg-white/10 transition-colors">
                  <div className="text-[10px] text-fino-text/60 mb-2 uppercase tracking-wide">Primer entregable</div>
                  <div className="text-3xl font-medium text-white mb-1">2–3 sem</div>
                  <div className="text-xs text-fino-text/80">Pantallas funcionales</div>
                </div>
                <div className="bg-white/5 rounded-2xl p-5 border border-white/5 hover:bg-white/10 transition-colors">
                  <div className="text-[10px] text-fino-text/60 mb-2 uppercase tracking-wide">Ownership</div>
                  <div className="text-3xl font-medium text-white mb-1">100%</div>
                  <div className="text-xs text-fino-text/80">Código es tuyo</div>
                </div>
              </div>
              <div className="bg-white/5 rounded-2xl p-6 border border-white/5">
                <div className="flex justify-between items-center mb-5">
                  <span className="text-xs text-fino-text/80 font-medium">Stack de entrega</span>
                  <span className="text-[10px] text-fino-purple bg-fino-purple/10 px-2 py-0.5 rounded border border-fino-purple/20">En desarrollo</span>
                </div>
                <div className="space-y-4">
                  {[
                    { name: "Discovery & Arquitectura", width: "100%", icon: <Layers size={10} className="text-fino-purple" /> },
                    { name: "Backend & APIs", width: "85%", icon: <Code2 size={10} className="text-fino-purple" /> },
                    { name: "Frontend & UX", width: "75%", icon: <Code2 size={10} className="text-fino-purple" /> },
                    { name: "Automatizaciones con IA", width: "65%", icon: <GitBranch size={10} className="text-fino-purple" /> },
                    { name: "Agentes de IA", width: "50%", icon: <Check size={10} className="text-fino-purple" /> }
                  ].map((item, i) => (
