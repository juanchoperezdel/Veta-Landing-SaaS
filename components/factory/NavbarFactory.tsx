      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <a href="/softwarefactory" className="flex items-center gap-3 group">
              <div className="w-10 h-10 flex items-center justify-center">
                <img src="/logo.png" alt="Veta" className="w-full h-full object-contain" />
              </div>
              <span className="text-xl font-medium tracking-tight text-white">Veta Dev</span>
            </a>
          </div>

          <div className="hidden md:flex items-center space-x-10">
            <a href="#inicio" className="text-sm font-medium text-fino-text hover:text-white transition-colors">Inicio</a>
            <a href="#diagnostico" className="text-sm font-medium text-fino-text hover:text-white transition-colors">Servicios</a>
            <a href="#solucion" className="text-sm font-medium text-fino-text hover:text-white transition-colors">Proceso</a>
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col items-center justify-center h-full space-y-8 p-8">
              ...
              <a href="#diagnostico" className="text-xl font-medium text-white hover:text-fino-purple transition-colors" onClick={() => setIsOpen(false)}>Servicios</a>
              <a href="#solucion" className="text-xl font-medium text-white hover:text-fino-purple transition-colors" onClick={() => setIsOpen(false)}>Proceso</a>
